...
public class Corregido {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in); //se corrige la mala
        // ortografia y la falta del .in
        ...
        // primwe
        System.out.print("Ingrese el nombre del programador: "); //faltaba parentesis
        nombreProgramador = sc.nextLine(); //estaba mal escrito

        System.out.print("Ingrese el correo electrónico: ");
        correo = sc.nextLine(); //se estaba usando mal la variable

        System.out.print("Ingrese la ciudad: ");
        ciudad = sc.nextLine(); //vairable no estaba declarada
        ...
        System.out.print("Cliente 1: "); //no habian puntos y comas, tambien estaba mal escrito el next
        cliente1 = sc.next();
        ...
        double bonusCliente1, bonusCliente2, bonusCliente3; //mal escrtitos
