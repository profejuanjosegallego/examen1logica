...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.print("🏙️ Ingrese la ciudad: ");
        ciudad = sc.nextLine();
